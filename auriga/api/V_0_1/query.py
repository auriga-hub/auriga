...
class ProductQuery:
	...
	def query(self, attributes=None, fields=None, search_term=None, start=0, item_group=None, page_length=0):
		"""
		Args:
		...
		# Add average_rating and total_reviews details in result.
		result = self.get_item_review(result)
	...
	def get_item_review(self, result):
		"""Add average_rating and total_reviews details in result."""
		for item in result:
			rating = get_item_reviews(item.name)
